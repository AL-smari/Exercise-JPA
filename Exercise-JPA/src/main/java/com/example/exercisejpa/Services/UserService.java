...
public class UserService {
    ...
    public boolean addMoreStocks( Integer productID, Integer merchantID, int amount) {
    ...
    public int userBuy( Integer userID, Integer productID, Integer merchantID) {
    ...
    public int banMerchant(Integer id, Integer merchantID) {
        int response = 0;
        int userTemp = 0;
