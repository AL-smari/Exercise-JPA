...
public class MerchantStockService {
    ...
    public int addMerchantStock(List<Product> products , List<Merchant> merchants ,MerchantStock merchantStock){
        int response =3;
    ...
    public int updateMerchantStock(List<Product> products , List<Merchant> merchants ,Integer id,MerchantStock merchantStock){
        int response=0;
